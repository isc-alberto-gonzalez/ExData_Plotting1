...
with(extract, plot(date.time,Global_active_power,type='l',xlab='',ylab='Global Active Power') )

with(extract, plot(date.time,Voltage,type='l',xlab='datetime',ylab='Voltage') )
...
with(extract, plot(date.time,Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power'))
